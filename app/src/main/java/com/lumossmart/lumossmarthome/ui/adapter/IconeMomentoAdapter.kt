...
import com.lumossmart.lumossmarthome.model.IconeMomentoEnum
import kotlinx.android.synthetic.main.item_icone.view.*

class IconeMomentoAdapter (private val icones: Array<IconeMomentoEnum>,
    ...
    override fun getItem(position: Int): IconeMomentoEnum {
